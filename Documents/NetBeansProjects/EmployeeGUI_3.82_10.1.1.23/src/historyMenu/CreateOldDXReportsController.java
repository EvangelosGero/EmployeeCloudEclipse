 ...
 * @author evgero
 */
public class CreateOldDXReportsController implements Initializable {
    ...
    private void handleCreateButton(ActionEvent event) {
        try {
            ...
            new SalaryReport.CreateDoroXmasReport().createDBDoroXmasReport(EmployeeGUI.con, year);
        } catch (SQLException ex) {
            Logger.getLogger(CreateOldDXReportsController.class.getName()).log(Level.SEVERE, null, ex);
