 ...
 * @author evgero
 */
public class CreateOldDPReportsController implements Initializable {
    ...
    private void handleCreateButton(ActionEvent event) {
        try {
            ...
            new SalaryReport.CreateDoroPashaReport().createDBDoroPashaReport(EmployeeGUI.con, year);
        } catch (SQLException ex) {
            Logger.getLogger(CreateOldDPReportsController.class.getName()).log(Level.SEVERE, null, ex);
