...
import com.dynamotors.dynashoppingcart.ejbs.SystemtableFacade;
...
public class SystemtableController implements Serializable {
    ...
    @EJB
    private com.dynamotors.dynashoppingcart.ejbs.SystemtableFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundle").getString("SystemtableCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundle").getString("SystemtableUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundle").getString("SystemtableDeleted"));
        if (!JsfUtil.isValidationFailed()) {
