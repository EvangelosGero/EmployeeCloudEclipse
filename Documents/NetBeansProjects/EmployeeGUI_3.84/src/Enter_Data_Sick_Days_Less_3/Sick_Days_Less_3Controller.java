 ...
 * @author Home
 */
public class Sick_Days_Less_3Controller implements Initializable {
    @FXML
    ...
    private void handleSaveBtn(ActionEvent event) throws SQLException {
        ...
        try {
            ...
            String query = "INSERT INTO SICK_DAYS_LESS_THAN_THREE (ID, EXIT_DAY, BACK_DAY) "+
                    "VALUES ( ?, ?, ?)";
            ...
            Logger.getLogger(Sick_Days_Less_3Controller.class.getName()).log(Level.SEVERE, null, ex);
